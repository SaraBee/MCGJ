...
def test_execute_and_query(app):
    ...
    values = (
        ...
        "Sara Bobo",
        "MissDat†Booty†",
        "https://open.spotify.com/track/4UJIkpP55qZuq1ecP5luqQ?si=E44FBYM0SXmwAuCM0dZ_wg",
        1,
        1,
        1,
        0,
        ...
        assert result == [
            {
                ...
                "person": "Sara Bobo",
                "title": "MissDat†Booty†",
                "url": "https://open.spotify.com/track/4UJIkpP55qZuq1ecP5luqQ?si=E44FBYM0SXmwAuCM0dZ_wg",
                "session_id": 1,
                "played": 1,
                "round_number": 1,
                "round_position": 0,
