...
def test_execute_and_query(app):
    ...
    execute_sql = "INSERT INTO tracks (id, create_date, update_date, person, track_name, track_url, session_id, done, round_number, round_position) VALUES (?,?,?,?,?,?,?,?,?,?)"
    ...
    with app.app_context():
        ...
        assert result == [{'id': '1', 'create_date': timestamp, 'update_date': timestamp, 'person': 'Sara Bobo', 'track_name': 'MissDat†Booty†', 'track_url': 'https://open.spotify.com/track/4UJIkpP55qZuq1ecP5luqQ?si=E44FBYM0SXmwAuCM0dZ_wg', 'session_id': 1, 'done': 1, 'round_number': 1, 'round_position': 0}]
